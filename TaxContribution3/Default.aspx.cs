...
public partial class _Default : Page
{
    ...
    protected void tbChildcareVouchers_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            lblCcvError.Text = "Please enter a positive number for childcare voucher amount";
            validInput = false;
        }
        else
        {
    ...
    void DrawCharts(TaxOutput taxOutput)
    {
        ...
        ClientScript.RegisterStartupScript(GetType(), "draw", "draw('" + taxOutput.PersonalAllowance + "','" 
